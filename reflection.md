...
I also learned that I should be more vigilant about applying comments consistently to document my changes before applying them.

I see github helping my future team projects by providing a clear, central location for cloud storage of files. It also maintains strong version control,
allowing memebers to propose changes without risk of overwriting each other's changes. I see branching useful for adding experimental features and allowing 
all members to interact with them without potentially risking the main branch.
